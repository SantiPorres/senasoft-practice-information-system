...
urlpatterns = [
    ...
    path('<slug:formation_area_slug>/sub-formation-area/', SubFormationAreaList.as_view(), name='sub_formation_areas_list'),
    path('<slug:formation_area_slug>/sub-formation-area/create', create_sub_formation_area, name='create_sub_formation_areas'),
